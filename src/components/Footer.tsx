          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center text-gray-300">
                ...
                <a href="mailto:team@andinia.solutions" className="hover:text-teal-400">team@andinia.solutions</a>
              </div>
              <div className="flex items-center text-gray-300">
                <Phone className="h-5 w-5 text-teal-400 mr-3 flex-shrink-0" />
                <a href="tel:+5492995061329" className="hover:text-teal-400">+54 9 299 506-1329</a>
              </div>
            </div>
          </div>
        </div>
